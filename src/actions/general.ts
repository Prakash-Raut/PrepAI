...
export async function createFeedback(params: CreateFeedbackParams) {
	...
	try {
		...
		const { object } = await generateObject({
			...
			prompt: `
				You are an AI interviewer analyzing a mock interview. Your task is to 
				evaluate the candidate based on structured categories. Be thorough and 
				detailed in your analysis. Don't be lenient with the candidate. 
		...
		let feedbackRef: FirebaseFirestore.DocumentReference<FirebaseFirestore.DocumentData>;
